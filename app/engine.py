...
def init(self, spark_session, movies_path, ratings_path):
self.spark = spark_session
self.sqlContext = SQLContext(spark_session)
self.movies_df = self.load_movies(movies_path)
...
engine = RecommendationEngine(spark, "ml-latest/movies.csv", "ml-latest/ratings.csv")
